...
WORKDIR /app
COPY package.json ./
# The committed lockfile only records the host platform's optional native
# binaries (rollup, sharp), so npm ci fails on linux/amd64 (npm/cli#4828).
# Resolve fresh for the build platform.
